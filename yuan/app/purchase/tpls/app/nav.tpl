...
<header class="b86">
    <div class="container">
        <div class="col-xs-12 header_top">
            ...
            <ul class="full_right">
                {x2;if:$_user['userid']}
                <li class="msg_hover"><a href="index.php?user-company-message-message" style="border-left:0px;padding:0px;width:40px;"><img src="app/core/styles/images/index/msg.png" style="width:18px;margin-top:-2px;"><span style="color: #ff0000;">{x2;$msgnum}</span></a></li>
        ...
        <div class="col-xs-12 header-bottom">
            <ul>
                ...
                <li><a href="index.php?purchase" style="color: #009944;">采购寻源</a></li>
                <!-- <li><a href="index.php?company-app-index">供应商展示</a></li> -->
                <!-- <li><a href="index.php?item">网格超市</a></li> -->
