...
{x2;endif}
		<div class="pagecontent" id="exampaper-paper-swiper">
			...
			$(document).ready(function(){
                ...
                $('#exampaper-paper-swiper').on('swiperight',function(){
                    if(qindex >= 1){
                        gotoindexquestion(--qindex);
                    }
                });
                $('#exampaper-paper-swiper').on('swipeleft',function(){
                    if(qindex < ($('#exampaper-paper-swiper .paperexamcontent').length-1)){
                        gotoindexquestion(++qindex);
                    }
                });
