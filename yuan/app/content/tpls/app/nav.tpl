<div class="container-fluid box" style="margin:0px auto;padding-top:10px;overflow:visible">
	<div class="row-fluid">
		<div class="main">
			<div class="col-xs-4">
				<h1 style="font-size:42px;color:#337AB7;"><img src="app/core/styles/img/logo2.png" style="height:60px;margin-top:-10px;"/>&nbsp;<b>数字化供应链</b></h1>
			</div>
				...
				<ul class="list-unstyled list-inline">
					...
					<li>
						<div class="btn-group">
							...
							<li><a class="ajax" href="javascript:;" target="_self" data="index.php?user-app-logout">退出登录</a></li>
		...
		<div class="main">
			<div class="col-xs-12">
				<ul class="list-unstyled list-inline">
					...
					<li class="menu col-xs-1"><a href="index.php?item">网格超市</a></li>
					<li class="menu col-xs-1"><a href="index.php?purchase">采购寻源</a></li>
					<li class="menu col-xs-1"><a href="index.php?invite">招投标</a></li>
					<!-- <li class="menu col-xs-1"><a href="index.php?item">网格超市</a></li> -->
					<li class="menu col-xs-1"><a href="index.php?content-app-content-wait">供应商</a></li>
					<!-- <li class="menu col-xs-1"><a href="index.php?content-app-content-wait">增值服务</a></li> -->
				</ul>
			</div>
		</div>
	</div>
