            ...
            <div class="right-content col10 pull-right">
                ...
                <div class="zmm_panel panel-default" id="datacontent">
                    ...
                    <div class="zmm-panel-body zmm-qy-dtxx zmm-qydt-shsj zmm-gsjj" >
                        <form action="index.php?user-company-basic-newsadd" method="post" class="form-horizontal">
                            <div class="form-group">
                                <label for="news_title" class="control-label col-sm-2">标题：</label>
                                <div class="col-sm-6">
                                    <input class="form-control" type="text" id="news_title" name="args[news_title]" needle="needle" msg="您必须输入标题">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="news_content" class="control-label col-sm-2">内容</label>
                                <div class="col-sm-10">
                                    <textarea id="news_content" rows="7" cols="4" class="ckeditor" name="args[news_content]"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
