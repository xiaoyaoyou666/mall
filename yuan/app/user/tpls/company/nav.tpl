...
<header class="b86">
    <div class="container">
        <div class="col-xs-12 header_top">
            ...
            <ul class="full_right">
                {x2;if:$_user['userid']}
                <li style="padding-top:3px;"><a href="index.php?user-company-message-message" style="border-left:0px;padding:0px;width:40px;"><img src="app/core/styles/images/index/msg.png" style="margin-top:-8px;width:18px;"><span style="color: #ff0000;padding-left:0px;">{x2;$msgnum}</span></a></li>
                ...
                <li class="phone" style="-webkit-transition:all 0s;">
                    ...
                    <ul class="sel_nav" style="width:103.5px;height: auto">
                ...
                <li ><a href="{x2;if:$_user['users_role']==0}index.php?user-company{x2;elseif:$_user['users_role']==3}index.php?user-company-index-evaluate_list{x2;elseif:$_user['users_role']==4}index.php?user-company-purchases-inquiry{x2;else}index.php?user-company-index-suplier_list{x2;endif}" style="padding-left:15px;">企业中心</a></li>
                ...
                <li class="phone" style="min-width: 109px;">
                    ...
                    <ul class="sel_nav" style="height:30px;text-align: center;">
                        <li><a href="index.php?user-app-logout">退出登录</a></li>
                    </ul>
        ...
        <div class="col-xs-12 header-bottom">
            <ul>
                ...
                <!--  <li><a href="index.php?company-app-index">供应商展示</a></li> -->
                <!-- <li><a href="index.php?item" style="color: #009944;">网格超市</a></li> -->
            ...
            <p class="full_right" style="margin-top:38px;">
                ...
                <input type="text" class="input_tx" id="searchKeyword" value="{x2;$keyword}" placeholder="请输入关键词" style="float: left;"><span class="input_span" id="tosearch"></span>
            </p>
...
//          {
//              case 1:
//                  url = 'index.php?item-app-index-search&stype=1&keyword='+searchKeyword;
//                  break;
//              default:
//                  url = 'index.php?item-app-index-search&stype=2&keyword='+searchKeyword;
//          }
