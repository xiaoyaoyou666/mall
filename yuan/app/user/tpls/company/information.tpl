				...
				<div class="right-content col10 pull-right contact-us">
					...
					<div>
						...
						<div class="zmm_panel panel-default">
							...
							<form class="form-horizontal" method="post" action="index.php?user-company-basic-information" id="form1">
								<!--三证合一-->
															...
															<div class="qq-upload-button-selector">
																<ul class="qq-upload-list-selector list-unstyled pull-left" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
																	<li class="text-center" style="margin-top:-5px;">
																		...
																		<a class="qq-upload-file-selector <br />pdf_name load" style="margin-top:-10px;margin-left: -86px;width: 114px;word-break: break-word;"></a>
																	</li>
																</ul>
																<ul class="qq-upload-list-selector list-unstyled pull-left" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
																	<li class="text-center" style="margin-top:-5px;">
																		...
																		<a class="qq-upload-file-selector pdf_name load" style="margin-top:-10px;margin-left: -86px;width: 114px;word-break: break-word;">{x2;if:$certificateInfo[6]['certificate_url']}{x2;$certificateInfo[6]['fileName']}{x2;endif}</a>
															...
															<div class="qq-upload-button-selector">
																<ul class="qq-upload-list-selector list-unstyled pull-left" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
																	<li class="text-center" style="margin-top:-5px;">
																		...
																		<a class="qq-upload-file-selector pdf_name load" style="margin-top:-10px;margin-left: -86px;width: 114px;word-break: break-word;"></a>
																	</li>
																</ul>
																<ul class="qq-upload-list-selector list-unstyled pull-left" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
																	<li class="text-center" style="margin-top:-5px;">
																		...
																		<a class="qq-upload-file-selector pdf_name load" style="margin-top:-10px;margin-left: -86px;width: 114px;word-break: break-word;">{x2;if:$certificateInfo[7]['certificate_url']}{x2;$certificateInfo[7]['fileName']}{x2;endif}</a>
																	</li>
																</ul>
															</div>
															...
															<div class="qq-upload-button-selector">
																<ul class="qq-upload-list-selector list-unstyled pull-left" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
																	<li class="text-center" style="margin-top:-5px;">
																		...
																		<a class="qq-upload-file-selector pdf_name load" style="margin-top:-10px;margin-left: -86px;width: 114px;word-break: break-word;" href="{x2;$certificateInfo[8]['certificate_url']}" download="{x2;$certificateInfo[8]['certificate_url']}"></a>
																	</li>
																...
																<ul class="qq-upload-list-selector list-unstyled pull-left" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
																	<li class="text-center" style="margin-top:-5px;">
																		...
																		<a class="qq-upload-file-selector pdf_name load" href="{x2;$certificateInfo[8]['certificate_url']}" download="{x2;$certificateInfo[8]['certificate_url']}" style="margin-top:-10px;margin-left: -86px;width: 114px;word-break: break-word;">{x2;if:$certificateInfo[8]['certificate_url']}{x2;$certificateInfo[8]['fileName']}{x2;endif}</a>
																	</li>
																</ul>
															</div>
								...
								<div class="col-md-12" style="text-align: center;margin-bottom: 10px;margin-top: 20px;">
									<button type="button" id="reg_btn" class="button_tt reg_button" style="width:100px">保存</button>
		...
		$(function() {
			...
			$('#reg_btn').on('click', function() {
				$.ajax({
					...
					url: "index.php?user-company-basic-information",
					dataType: 'json',
