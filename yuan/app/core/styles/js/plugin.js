                ...
                switch (type) {
                    case 'confirm':
                        ...
                        if ($(obj).attr('msg') && ($(obj).attr('msg') != "")) {
                            ...
                            msg = '您确定要删除吗？';
                        //				var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:550px;\"><div class=\"modal-content\"><div class=\"modal-header\"><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" autocomplete=\"off\"><span aria-hidden=\"true\">×</span></button><h4 class=\"modal-title\" id=\"myModalLabel\">操作确认</h4></div><div class=\"modal-body\"><p class=\"text-danger\" style=\"font-size:1.2em;\">"+msg+"</p></div><div class=\"modal-footer\"><button class=\"layui-btn layui-btn-sm\" onclick=\"javascript:submitAjax({'url':'"+url+"'});\">确定</button><button class=\"layui-btn layui-btn-sm\" onclick=\"javascript:$.zoombox.hide();\">取消</button></div></div></div>";
                        var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:362px!important;margin-top:160px;height:261px;border: 1px solid #ccc;border-radius: 5px;\"><div class=\"modal-content\" style=\"box-shadow: 0px 0px 10px 5px rgba(0, 0, 0, .1)!important;height:262px;border-radius:5px!important ;overflow:hidden;><div style=\"border:0px;width:362px;box-sizing: border-box;\"><div class=\"top\" style=\"width:100% ;height:42px;background:#f9f9f9 ;border-bottom: 1px solid #dddddd;box-sizing: border-box;\"><p style=\"width: 90%;margin: 0 auto;height: 100%;line-height:42px ;box-sizing: border-box;\"><span style=\"float: left;\">提示</span><button type=\"button\" class=\"close pull-right\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"font-size:2em;float: right;margin-top: 7px;\">×</button></p></div><img style=\"width: 53px;margin:30px auto;display: block;\" src=\"./app/core/styles/img/question.png\"/><p style=\"text-align:center;color: #323232;font-size: 16px;\">" + msg + "</p><div class=\"modal-footer\" style=\"border:none;\"><button style=\"margin-right:10px;background:#009944;border-color:#009944\" class=\"btn btn-primary\" onclick=\"javascript:submitAjax({'url':'" + url + "'});\">确定</button><button  class=\"btn btn-default btn-cancel\" onclick=\"javascript:$.zoombox.hide();\">取消</button></div></div></div></div>"
                        m.html(cnt);
                    ...
                    case 'dingbiao':
                        ...
                        if ($(obj).attr('msg') && ($(obj).attr('msg') != "")) {
                            ...
                            msg = '定标结果不可变更，系统将自动生成采购订单，是否确认？';
                        //              var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:550px;\"><div class=\"modal-content\"><div class=\"modal-header\"><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" autocomplete=\"off\"><span aria-hidden=\"true\">×</span></button><h4 class=\"modal-title\" id=\"myModalLabel\">操作确认</h4></div><div class=\"modal-body\"><p class=\"text-danger\" style=\"font-size:1.2em;\">"+msg+"</p></div><div class=\"modal-footer\"><button class=\"layui-btn layui-btn-sm\" onclick=\"javascript:submitAjax({'url':'"+url+"'});\">确定</button><button class=\"layui-btn layui-btn-sm\" onclick=\"javascript:$.zoombox.hide();\">取消</button></div></div></div>";
                        var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:362px!important;margin-top:160px;height:261px;border: 1px solid #ccc;border-radius: 5px;\"><div class=\"modal-content\" style=\"box-shadow: 0px 0px 10px 5px rgba(0, 0, 0, .1)!important;height:262px;border-radius:5px!important ;overflow:hidden;><div style=\"border:0px;width:362px;box-sizing: border-box;\"><div class=\"top\" style=\"width:100% ;height:42px;background:#f9f9f9 ;border-bottom: 1px solid #dddddd;box-sizing: border-box;\"><p style=\"width: 90%;margin: 0 auto;height: 100%;line-height:42px ;box-sizing: border-box;\"><span style=\"float: left;\">提示</span><button type=\"button\" class=\"close pull-right\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"font-size:2em;float: right;margin-top: 7px;\">×</button></p></div><img style=\"width: 53px;margin:30px auto;display: block;\" src=\"./app/core/styles/img/question.png\"/><p style=\"text-align:center;color: #323232;font-size: 16px;padding:0 24px;\">" + msg + "</p><div class=\"modal-footer\" style=\"border:none;padding-top:5px\"><button style=\"margin-right:10px;background:#009944;border-color:#009944\" class=\"btn btn-primary\" onclick=\"javascript:submitAjax({'url':'" + url + "'});\">确定</button><button  class=\"btn btn-default btn-cancel\" onclick=\"javascript:$.zoombox.hide();\">取消</button></div></div></div></div>"
                        m.html(cnt);
                        m.modal({'backdrop': false});
                        break;
                    /*扩展模态框
                     * 参数obj中增加按钮相关信息，多个按钮以数组形式展现;eg:
                     * obj={
                     * msg:'',//提示message
                     * buttons:[{
                     *       text:"确定",
                     *       isHref:false,//是否子在本页面跳转
                     *       formSelector:".form-add-product",//需要提交的表单选择器
                     *       url:'index.php?user-company-items-confirm',
                     *       isCancel:true//是否点击直接关闭
                     *      },
                     *      {
                     *       text:"取消",
                     *       isCancel:true,
                     *       url:'index.php?user-company-items-cancel',
                     *      }...
                     *      ]
                     * }
                     * */
                    case 'customConfirm':
                        ...
                        if (obj.buttons) {
                            for (var i = 0, len = obj.buttons.length; i < len; i++) {
                                if (obj.buttons[i].isCancel) {
                                    buttonHtml = "<button class=\"btn btn-primary subbtn\" onclick=\"javascript:$.zoombox.hide();\">"+obj.buttons[i].text+"</button>";
                                } else{
                                    if (!obj.buttons[i].isHref) {
                                        buttonHtml += "<button style=\"margin:0 10px 0 14px\" class=\"btn btn-primary subbtn\" onclick=\"javascript:customSubmit({'url':'" + obj.buttons[i].url + "','formSelector':'" + obj.buttons[i].formSelector + "'});\">" + obj.buttons[i].text + "</button>";
                                    }
                                    else {
                                        buttonHtml += '<a style=\"margin:0 10px 0 14px\" class=\"btn btn-primary subbtn\" href="' + obj.buttons[i].url + '" >' + obj.buttons[i].text + '</a>';
                                    }
                                }
                            }
                        } else {
                            buttonHtml = "<button style=\"margin:0 10px 0 14px\" class=\"btn btn-primary subbtn\" onclick=\"javascript:submitAjax({'url':'" + url + "'});\">确定</button>" +
                                "<button class=\"btn\" onclick=\"javascript:$.zoombox.hide();\">取消</button>";
                        }

                        var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:362px!important;margin-top:160px;height:261px;border: 1px solid #ccc;border-radius: 5px;\">" +
                            ...
                            "<div style=\"border:0px;width:362px;box-sizing: border-box;\"><div class=\"top\" style=\"width:99.4% ;height:42px;background:#f9f9f9 ;border-bottom: 1px solid #dddddd;box-sizing: border-box;\">" +
                            "<p style=\"width: 90%;margin: 0 auto;height: 100%;line-height:42px ;box-sizing: border-box;\">" +
                            "<span style=\"float: left;\">提示</span><button type=\"button\" class=\"close pull-right\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"font-size:2em;float: right;margin-top: 8px;\">×</button>" +
                            "</p>" +
                            "</div>" +
                            "<img style=\"width: 53px;margin:30px auto;display: block;\" src=\"./app/core/styles/img/1.png\"/>" +
                            "<p style=\"text-align:center;color: #323232;font-size: 16px;\">" + msg + "</p>" +
                    ...
                    case 'modify':
                        ...
                        if ($(obj).attr('msg') && ($(obj).attr('msg') != "")) {
                            ...
                            msg = '如果您想知道商品价格，请先登录';
                        //				var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:550px;\"><div class=\"modal-content\"><div class=\"modal-header\"><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" autocomplete=\"off\"><span aria-hidden=\"true\">×</span></button><h4 class=\"modal-title\" id=\"myModalLabel\">操作确认</h4></div><div class=\"modal-body\"><p class=\"text-danger\" style=\"font-size:1.2em;\">"+msg+"</p></div><div class=\"modal-footer\"><button class=\"layui-btn layui-btn-sm\" onclick=\"javascript:$.zoombox.hide();\">知道了</button></div></div></div>";
                        var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:362px;margin-top:160px;height:261px;border: 1px solid #ccc;border-radius: 5px;\"><div class=\"modal-content\" style=\"box-shadow: 0px 0px 10px 5px rgba(0, 0, 0, .1)!important;height:262px;border-radius:5px!important ;overflow:hidden;><div style=\"border:0px;width:362px;box-sizing: border-box;\"><div class=\"top\" style=\"width:100% ;height:42px;background:#f9f9f9 ;border-bottom: 1px solid #dddddd;box-sizing: border-box;\"><p style=\"width: 90%;margin: 0 auto;height: 100%;line-height:42px ;box-sizing: border-box;\"><span style=\"float: left;\">提示</span><button type=\"button\" class=\"close pull-right\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"font-size:2em;float: right;margin-top: 8px;\">×</button></p></div><img style=\"width: 53px;margin:30px auto;display: block;\" src=\"./app/core/styles/img/1.png\"/><p style=\"text-align:center;color: #323232;font-size: 16px;\">" + msg + "</p><div class=\"modal-footer\" style=\"border:none;\"><button style=\"margin-right:10px;background:#009944;border-color:#009944\" class=\"btn btn-primary\" onclick=\"javascript:window.location.href='index.php?user-app-login&t=2';\">确定</button><button class=\"btn\" onclick=\"javascript:$.zoombox.hide();\">取消</button></div></div></div></div>"
                        m.html(cnt);
                        m.modal({'backdrop': false});
                        break;
                    ...
                    case 'collect':
                        ...
                        if ($(obj).attr('msg') && ($(obj).attr('msg') != "")) {
                            ...
                            msg = '框架协议生效后，协议内容将不可变更。<br/>是否确认生效？';
                        //              var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:550px;\"><div class=\"modal-content\"><div class=\"modal-header\"><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" autocomplete=\"off\"><span aria-hidden=\"true\">×</span></button><h4 class=\"modal-title\" id=\"myModalLabel\">操作确认</h4></div><div class=\"modal-body\"><p class=\"text-danger\" style=\"font-size:1.2em;\">"+msg+"</p></div><div class=\"modal-footer\"><button class=\"layui-btn layui-btn-sm\" onclick=\"javascript:submitAjax({'url':'"+url+"'});\">确定</button><button class=\"layui-btn layui-btn-sm\" onclick=\"javascript:$.zoombox.hide();\">取消</button></div></div></div>";
                        var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:378px!important;margin-top:160px;height:261px;border: 1px solid #ccc;border-radius: 5px;\"><div class=\"modal-content\" style=\"box-shadow: 0px 0px 10px 5px rgba(0, 0, 0, .1)!important;height:262px;border-radius:5px!important ;overflow:hidden;><div style=\"border:0px;width:362px;box-sizing: border-box;\"><div class=\"top\" style=\"width:100% ;height:42px;background:#f9f9f9 ;border-bottom: 1px solid #dddddd;box-sizing: border-box;\"><p style=\"width: 90%;margin: 0 auto;height: 100%;line-height:42px ;box-sizing: border-box;\"><span style=\"float: left;margin-left:145px;font-size:18px;\">生效确认</span><button type=\"button\" class=\"close pull-right\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"font-size:2em;float: right;margin-top: 7px;\">×</button></p></div><p style=\"text-align:center;color: #323232;font-size: 16px;margin-top: 50px;\">" + msg + "</p><br/><div class=\"modal-footer\" style=\"border:none;\"><button style=\"margin-right:10px;background:#009944;border-color:#009944\" class=\"btn btn-primary\" onclick=\"javascript:submitAjax({'url':'" + url + "'});\">确定</button><button  class=\"btn btn-default btn-cancel\" onclick=\"javascript:$.zoombox.hide();\">取消</button></div></div></div></div>"
                        m.html(cnt);
                        m.modal({'backdrop': false});
                        break;
                    ...
                    case 'invalid':
                        ...
                        if ($(obj).attr('msg') && ($(obj).attr('msg') != "")) {
                            ...
                            msg = '框架协议失效后，不可以协议价交易。<br/>是否申请失效？';
                        //              var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:550px;\"><div class=\"modal-content\"><div class=\"modal-header\"><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" autocomplete=\"off\"><span aria-hidden=\"true\">×</span></button><h4 class=\"modal-title\" id=\"myModalLabel\">操作确认</h4></div><div class=\"modal-body\"><p class=\"text-danger\" style=\"font-size:1.2em;\">"+msg+"</p></div><div class=\"modal-footer\"><button class=\"layui-btn layui-btn-sm\" onclick=\"javascript:submitAjax({'url':'"+url+"'});\">确定</button><button class=\"layui-btn layui-btn-sm\" onclick=\"javascript:$.zoombox.hide();\">取消</button></div></div></div>";
                        var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:386px!important;margin-top:160px;height:261px;border: 1px solid #ccc;border-radius: 5px;\"><div class=\"modal-content\" style=\"box-shadow: 0px 0px 10px 5px rgba(0, 0, 0, .1)!important;height:262px;border-radius:5px!important ;overflow:hidden;><div style=\"border:0px;width:362px;box-sizing: border-box;\"><div class=\"top\" style=\"width:100% ;height:42px;background:#f9f9f9 ;border-bottom: 1px solid #dddddd;box-sizing: border-box;\"><p style=\"width: 90%;margin: 0 auto;height: 100%;line-height:42px ;box-sizing: border-box;\"><span style=\"float: left;margin-left:145px;font-size:18px;\">失效确认</span><button type=\"button\" class=\"close pull-right\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"font-size:2em;float: right;margin-top: 7px;\">×</button></p></div><p style=\"text-align:center;color: #323232;font-size: 16px;margin-top: 50px;\">" + msg + "</p><br/><div class=\"modal-footer\" style=\"border:none;\"><button style=\"margin-right:10px;background:#009944;border-color:#009944\" class=\"btn btn-primary\" onclick=\"javascript:submitAjax({'url':'" + url + "'});\">确定</button><button  class=\"btn btn-default btn-cancel\" onclick=\"javascript:$.zoombox.hide();\">取消</button></div></div></div></div>"
                        m.html(cnt);
                        m.modal({'backdrop': false});
                        break;
                    ...
                    case 'ajax':
                        var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:362px;margin-top:160px;height:261px;border-radius: 5px;\"><div class=\"modal-content\" style=\"box-shadow: 0px 0px 10px 5px rgba(0, 0, 0, .1)!important;height:262px;border-radius:5px!important ;overflow:hidden;\"><div style=\"border:0px;width:362px;box-sizing: border-box;\"><div class=\"top\" style=\"width:100% ;height:42px;background:#f9f9f9 ;border-bottom: 1px solid #dddddd;box-sizing: border-box;\"><p style=\"width: 90%;margin: 0 auto;height: 100%;line-height:42px ;box-sizing: border-box;\"><span style=\"float: left;\">提示</span><span  class=\"close pull-right\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"font-size:2em;float: right;margin-top: 6px;width:14px!important\">×</span></p></div><img style=\"width: 53px;margin:30px auto;display: block;\" src=\"./app/core/styles/img/2.png\"/><p style=\"text-align:center;color: #323232;font-size: 16px;\">" + obj.message + "</p><p class=\"close pull-right ghp\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"width: 100px;height: 30px;margin:20px auto;text-align: center;line-height: 30px;float: none!important;background: #e4e4e4;font-size: 16px;font-weight: normal;color: #666;border-radius: 5px;opacity:7;\">知道了</p></div></div></div>";
                        ...
                        var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:362px;margin-top:160px;height:261px;border-radius: 5px;\"><div class=\"modal-content\" style=\"box-shadow: 0px 0px 10px 5px rgba(0, 0, 0, .1)!important;height:262px;border-radius:5!important ;overflow:hidden;\"><div style=\"border:0px;width:362px;box-sizing: border-box;\"><div class=\"top\" style=\"width:100% ;height:42px;background:#f9f9f9 ;border-bottom: 1px solid #dddddd;box-sizing: border-box;\"><p style=\"width: 90%;margin: 0 auto;height: 100%;line-height:42px ;box-sizing: border-box;\"><span style=\"float: left;\">提示</span><span class=\"close pull-right\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"font-size:2em;float: right;margin-top: 6px;width:14px!important\">×</span></p></div><img style=\"width: 53px;margin:30px auto;display: block;\" src=\"./app/core/styles/img/2.png\"/><p style=\"text-align:center;color: #323232;font-size: 16px;\">" + $(obj).attr('message') + "</p><p class=\"close pull-right ghp\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"width: 100px;height: 30px;margin:20px auto;text-align: center;line-height: 30px;float: none!important;background: #e4e4e4;font-size: 16px;font-weight: normal;color: #666;border-radius: 5px;opacity:7;\">知道了</p></div></div></div>";
                        m.html(cnt);
                        m.modal({'backdrop': false});
                        break;

                    case 'ajaxOK':
                        var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:362px;margin-top:160px;height:261px;border: 1px solid #ccc;border-radius: 5px;\"><div class=\"modal-content\" style=\"box-shadow: 0px 9px -2px rgba(0, 0, 0, .15)!important;height:262px;border-radius:5px!important ;overflow:hidden;><div style=\"border:0px;width:362px;box-sizing: border-box;\"><div class=\"top\" style=\"width:99.4% ;height:42px;background:#f9f9f9 ;border-bottom: 1px solid #dddddd;box-sizing: border-box;\"><p style=\"width: 90%;margin: 0 auto;height: 100%;line-height:42px ;box-sizing: border-box;\"><span style=\"float: left;\">提示</span><button type=\"button\" class=\"close pull-right\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"font-size:2em;float: right;margin-top: 8px;\">×</button></p></div><img style=\"width: 53px;margin:30px auto;display: block;\" src=\"./app/core/styles/img/1.png\"/><p style=\"text-align:center;color: #323232;font-size: 16px;\">" + obj.message + "</p><p class=\"close pull-right ghp\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"width: 100px;height: 30px;margin:20px auto;text-align: center;line-height: 30px;float: none!important;background: #e4e4e4;font-size: 16px;font-weight: normal;color: #666;border-radius: 5px;opacity:7;\">知道了</p></div></div></div>";
                        ...
                        var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:362px;margin-top:160px;height:261px;border-radius: 5px;\"><div class=\"modal-content\" style=\"box-shadow: 0px 0px 10px 5px rgba(0, 0, 0, .1)!important;height:262px;border-radius:5px!important ;overflow:hidden;\"><div style=\"border:0px;width:362px;box-sizing: border-box;\"><div class=\"top\" style=\"width:100% ;height:42px;background:#f9f9f9 ;border-bottom: 1px solid #dddddd;box-sizing: border-box;\"><p style=\"width: 90%;margin: 0 auto;height: 100%;line-height:42px ;box-sizing: border-box;\"><span style=\"float: left;\">提示</span><button type=\"button\" class=\"close pull-right\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"font-size:2em;float: right;margin-top: 8px;\">×</button></p></div><img style=\"width: 53px;margin:30px auto;display: block;\" src=\"./app/core/styles/img/1.png\"/><p style=\"text-align:center;color: #323232;font-size: 16px;\">" + $(obj).attr('message') + "</p><p class=\"close pull-right ghp\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"width: 100px;height: 30px;margin:20px auto;text-align: center;line-height: 30px;float: none!important;background: #e4e4e4;font-size: 16px;font-weight: normal;color: #666;border-radius: 5px;opacity:7;\">知道了</p></div></div></div>";
                        m.html(cnt);
                        m.modal({'backdrop': false});
                        break;

                    default:
                        var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:362px;margin-top:160px;height:261px;border-radius: 5px;\"><div class=\"modal-content\" style=\"box-shadow: 0px 0px 10px 5px rgba(0, 0, 0, .1)!important;height:262px;border-radius:5!important ;overflow:hidden;\"><div style=\"border:0px;width:362px;box-sizing: border-box;\"><div class=\"top\" style=\"width:100% ;height:42px;background:#f9f9f9 ;border-bottom: 1px solid #dddddd;box-sizing: border-box;\"><p style=\"width: 90%;margin: 0 auto;height: 100%;line-height:42px ;box-sizing: border-box;\"><span style=\"float: left;\">提示</span><button type=\"button\" class=\"close pull-right\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"font-size:2em;float: right;margin-top: 8px;\">×</button></p></div><img style=\"width: 53px;margin:30px auto;display: block;\" src=\"./app/core/styles/img/2.png\"/><p style=\"text-align:center;color: #323232;font-size: 16px;\">" + $(obj).attr('message') + "</p><p class=\"close pull-right ghp\" data-dismiss=\"modal\" aria-hidden=\"true\" style=\"width: 100px;height: 30px;margin:20px auto;text-align: center;line-height: 30px;float: none!important;background: #e4e4e4;font-size: 16px;font-weight: normal;color: #666;border-radius: 5px;opacity:7;\">知道了</p></div></div></div>";
                        m.html(cnt);
 ...
 *
 * */
function customSubmit(params) {
    if (params.formSelector) {
        $(params.formSelector).submit();
    }
                ...
                if (tmp) {
                    ...
                    if (data && data.substring(0, 6) != 'error:')
                        if (parms.target) {
                            ...
                            $("a.cancel", dom).each(cancelDialog);
                            $("a.bcancel", dom).each(bcancelDialog);
                            $("a.enddel", dom).each(enddelDialog);
                            $("a.dingbiao", dom).each(dingbiaoDialog);
                            $("a.modify", dom).each(modifyDialog);
                            $("a.collect", dom).each(collectDialog);
                            $("a.invalid", dom).each(invalidDialog);
...
function modalAjax() {
    ...
    $.get(url + '&' + Math.random(), function (data) {
        ...
        c.find("a.cancel").each(cancelDialog);
        c.find("a.bcancel").each(bcancelDialog);
        c.find("a.enddel").each(enddelDialog);
        c.find("a.dingbiao").each(dingbiaoDialog);
        c.find("a.modify").each(modifyDialog);
        c.find("a.collect").each(collectDialog);
        c.find("a.invalid").each(invalidDialog);
        m.modal();
    })
}
...
function cancelDialog() {
    ...
    $(_this).attr('href', 'javascript:;')
    $(_this).on('click', function () {
        $.zoombox.show('cancel', _this, href);
    });
}

function bcancelDialog() {
    var _this = this;
    var href = $(_this).attr('href');
    $(_this).attr('href', 'javascript:;')
    $(_this).on('click', function () {
        $.zoombox.show('bcancel', _this, href);
    });
}

function enddelDialog() {
    var _this = this;
    var href = $(_this).attr('href');
    $(_this).attr('href', 'javascript:;')
    $(_this).on('click', function () {
        $.zoombox.show('enddel', _this, href);
    });
}

function dingbiaoDialog() {
    var _this = this;
    var href = $(_this).attr('href');
    $(_this).attr('href', 'javascript:;')
    $(_this).on('click', function () {
        $.zoombox.show('dingbiao', _this, href);
    });
}
function modifyDialog() {
    ...
    $(_this).attr('href', 'javascript:;')
    $(_this).on('click', function () {
        $.zoombox.show('modify', _this, href);
    });
}
...
function collectDialog() {
    ...
    $(_this).attr('href', 'javascript:;')
    $(_this).on('click', function () {
        $.zoombox.show('collect', _this, href);
    });
}
...
function invalidDialog() {
    ...
    $(_this).attr('href', 'javascript:;')
    $(_this).on('click', function () {
        $.zoombox.show('invalid', _this, href);
    });
}
...
function inituploader() {
    ...
    //文件类型失败提示文描
    var typeError = $(_this).attr('type-error')?$(_this).attr('type-error'):'文件类型上传失败';
    //文件大小失败提示文描
    var sizeError = $(_this).attr('size-error')?$(_this).attr('size-error'):'文件大小小于100M后重新上传';
    ...
    //loading html
    var html = '<div class="load-progress-bar">' +
        '<img id="progress-loading" src="app/core/styles/images/loading.gif"/><i class="loading-note">上传中</i>' +
        '</div>';

    /*
     * loadType--'outer'[默认]：作为模态框播放loading动画
     *         --'inner'：在当前上传按钮之后播放loading动画
     */
    var loadType;
    switch($(_this).attr('load-type')){
        case 'outer':
            loadType = 'outer';
            break;
        case 'inner':
    ...
    return new qq.FineUploader({
        ...
        'thumbnails': {
            'placeholders': {
                'waitingPath': 'app/core/styles/images/loading.gif',
        ...
        'text': {
            defaultResponseError: '连接服务器失败，请重试'
        },
        'callbacks': {
            'onSubmit': function (id, fileName) {
                //标识文件上传状态-false未上传或上传失败；true上传成功
                UPLOADFILE_STATUS = false;
                if (petype != 'list') {
            ...
            'onProgress': function (id, fileName, loaded, total) {
                ...
                //loading动画加载
                if (loadType && loadType === 'inner') {
                    $(_this).find('.qq-upload-list-selector .uploaded-show').append(html);
                }
                $(_this).find('.delete-file-btn').on('click',function () {
                    $(this).closest('.uploaded-show').remove();
                })
            },
            ...
            'onError': function (event, id, name, errorReason, xhrOrXdr) {
                ...
                $(_this).find('.error-reason').remove();
                //移除loading动画
                if(loadType && loadType === 'inner'){
                    $(_this).find('.qq-upload-list-selector').find('.load-progress-bar').remove();
                    return false;
                }
            },
            //上传完成 --【无论失败成功均执行此方法】
            'onComplete': function (id, fileName, responseJSON) {
                if(responseJSON.success){
                    ...
                    if (petype == 'list') {
                        ...
                        //如果设置了最大上传数量，会在上传到最大界值时不在显示上传按钮--bymafang20180808
                        if ($(_this).attr('max-length') && $(_this).siblings(".sortable").find(".listimgselector").length > 0 && $(_this).siblings(".sortable").find(".listimgselector").length >= parseInt($(_this).attr('max-length'))) {
                            $(_this).hide();
                        }
                    }
                    ...
                    //移除loading动画
                    if(loadType && loadType === 'inner'){
                        $(_this).find('.uploaded-show').find('.load-progress-bar').remove();
                    }

                }else{
                    alert('上传文件失败');
                    if(loadType && loadType === 'inner') {
                        $(_this).find('.qq-upload-list-selector').find('li').show();
                        $(_this).find('.uploaded-show').remove();
                    }
                }
...
$(function () {
    ...
    $("a.cancel").each(cancelDialog);
    $("a.bcancel").each(bcancelDialog);
    $("a.enddel").each(enddelDialog);
    $("a.dingbiao").each(dingbiaoDialog);
    $("a.modify").each(modifyDialog);
    $("a.collect").each(collectDialog);
    $("a.invalid").each(invalidDialog);
    $('a.poproom').popover();
    $('.sortable').sortable();
