...
<div class="goods" id="content">
    <div class="g-content">
        <div class="head">当前位置：<a href="index.php?core-master-audit-statistics">订单管理</a>&nbsp;>&nbsp;订单统计</div>
        <!--content-->
        <div class="shop_list">
        	<div class="liv">
        		<dl>
        			<dt><img src="app/core/styles/images/image_sining1.png"/></dt>
        			<dd class="liv_a">今日订单总数</dd>
        			<dd class="liv_b">{x2;$count['number']}单</dd>
        		</dl>
        	</div>
        	<div class="liv">
        		<dl>
        			<dt><img src="app/core/styles/images/image_sining3.png"/></dt>
        			<dd class="liv_a">今日销售总额</dd>
        			<dd class="liv_b">￥{x2;$count['price']}</dd>
        		</dl>
        	</div>
        	<div class="liv">
        		<dl>
        			<dt><img src="app/core/styles/images/image_sining2.png"/></dt>
        			<dd class="liv_a">昨日销售总额</dd>
        			<dd class="liv_b">￥{x2;$today['price']}</dd>
        		</dl>
        	</div>
        </div>
    </div>
