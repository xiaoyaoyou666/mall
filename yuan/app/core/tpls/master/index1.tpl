...
<header>
    <div id="logo">
        <a href="index.php" style="display:inline-block;width:220px;text-align:center;" id="a"><img style="width: 182px;margin-top: 10px" src="app/core/styles/admin/images/bj.png"></a>
    </div>
    <ul id="u1">
        {x2;if:$_user['userid']}
        <li><a class="ajax" href="index.php?user-app-logout"><em class="glyphicon glyphicon-log-out"></em>退出登录 </a></li>
        <li>
...
<nav>
    <ul id="u2">
        ...
        <li>
            ...
            <ul class="ul2">
               ...
               <li><a href="index.php?item-master-items-collect"><i class="layui-icon layui-icon-star"></i>商品收藏排行</a></li>
                ...
                <li><a href="index.php?item-master-module"><i class="layui-icon layui-icon-diamond"></i>模型管理</a></li>
            </ul>
        </li>
          <li>
        ...
        <li>
            <span><i class="layui-icon layui-icon-tree"></i>寻源管理<em style="float:right;margin-right: 14px" class="layui-icon layui-icon-right"></em></span>
            <ul class="ul2">
                <li><a href="index.php?user-master-user-inquiry"><i class="layui-icon layui-icon-chart-screen"></i>询价管理</a></li>
                <li><a href="index.php?agreement-master-agreement-agreementJournal" ><i class="layui-icon layui-icon-engine"></i>报价管理</a></li>
            </ul>
        </li>
         <li>
