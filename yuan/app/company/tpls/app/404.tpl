    ...
    <div class="container">
        <div class="col-xs-12 header_top">
            ...
            <ul class="full_right">
                ...
                <li class="phone" style="min-width: 109px;">
                    <a href="{x2;if:$_user['users_role']==0}index.php?user-company{x2;elseif:$_user['users_role']==3}index.php?user-company-index-evaluate_list{x2;else}index.php?user-company-index-suplier_list{x2;endif}">{x2;$_user['username']}</a>
        ...
        <div class="col-xs-12 header-bottom">
            <ul>
                ...
                <li><a href="index.php?company-app-index-wait" style="color: #009944;">招投标</a></li>
            </ul>
