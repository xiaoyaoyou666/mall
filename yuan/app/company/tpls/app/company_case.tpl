...
<div class="zmm-zx-centent">
    <div class="container">
        ...
        <div class="hln-zx-centent-title t20 b20">
            你所在的位置：
            <span><a href="index.php">首页</a> > <a href="index.php?enterprise">成功案例</a> > <a>{x2;$user['company_name']}</a></span>
        </div>
        <!-- 导航 end -->
                            ...
                            <div class="zmm-panel-body zmm-qy-dtxx zmm-qydt-shsj zmm-gsjj">
                                <table>
                                    ...
                                    {x2;tree:$data,vv,cid}
                                        <tr class="table-tr2">
                                            <td class="table-td1">
                                                <img style="width: 120px;height: 80px;" class="case_img" src="{x2;v:vv['case_logo']}">
                                            </td>
                                            <td class="table-td2">
                                                {x2;v:vv['case_title']}
                                            </td>
                                            <td class="table-td3">
                                                {x2;v:vv['case_category']}
                                            </td>
                                            <td class="table-td3">
                                                <a target="_blank" class="bj_a" href="index.php?company-app-company-caseInfo&case_id={x2;v:vv['case_id']}&companyid={x2;v:vv['company_id']}">查看</a>
                                            </td>
                                        </tr>
                                    {x2;endtree}
                                    </tbody></table>
