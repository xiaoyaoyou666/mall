...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;overflow:visible">
					...
					<form action="index.php?purchase-master-purchases-lite" method="post" class="form-horizontal">
						<div class="form-group">
				            <label class="control-label col-sm-2">内容ID</label>
				            <div class="col-sm-4">
			        			<input class="form-control" type="text" name="purchaseids" value="{x2;$purchaseids}" needle="needle" msg="您必须输入标题" readonly>
				        	</div>
				        </div>
				        <div class="form-group">
		        			<label class="control-label col-sm-2">目标分类</label>
		        			<div class="col-sm-4">
			        			<select class="form-control" msg="您必须选择一个目标分类" needle="needle" class="autocombox input-medium" name="targetcatid" refUrl="index.php?purchase-master-category-ajax-getchildcategory&catid={value}">
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-9">
					            ...
					            <a class="btn btn-primary" href="index.php?purchase-master-purchases&page={x2;$page}{x2;$u}">取消</a>
