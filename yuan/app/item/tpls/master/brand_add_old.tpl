...
{x2;endif}
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?{x2;$_app}-master-category">品牌管理</a></li>
				...
				<div class="box itembox">
					<h4 class="title" style="padding:10px;">
						<a href="#">添加品牌</a>
						<a class="pull-right btn btn-primary" href="index.php?{x2;$_app}-master-brands&parent={x2;$parent}">品牌列表</a>
					</h4>
					<form action="index.php?{x2;$_app}-master-brands-add" method="post" class="form-horizontal">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" name="args[brandid]" value="{x2;$brands['brandid']}" datatype="english" needle="needle" msg="您必须输入中文品牌名称">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" name="args[brandtitle]" value="{x2;$brands['brandtitle']}" needle="needle" msg="您必须输入中文品牌名称">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" name="args[brandcountry]" value="{x2;$brands['brandcountry']}" needle="needle" msg="您必须输入品牌所属国家">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<textarea class="ckeditor" rows="7" id="branddescribe" name="args[branddescribe]"></textarea>
