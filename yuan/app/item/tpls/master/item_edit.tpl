...
{x2;endif}
				...
				<div class="box itembox">
					...
					<form action="index.php?item-master-items-edititem" method="post" class="form-horizontal">
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-4">
				            	<input type="text" name="args[itemnumber]" needle="needle" class="form-control" value="{x2;$item['itemnumber']}" msg="您必须输入库存">
				            </div>
				        </div>
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-9">
				            	<label class="radio-inline"><input type="radio" name="args[itemstatus]" value="1"{x2;if:$item['itemstatus']} checked{x2;endif} /> 上架</label>
				            	<label class="radio-inline"><input type="radio" name="args[itemstatus]" value="0"{x2;if:!$item['itemstatus']} checked{x2;endif} /> 下架</label>
				            </div>
				        </div>
				        <div class="form-group">
