    ...
    <ul id="u2">
        ...
        <li>
            ...
            <ul class="ul2">
                ...
                <li><a href="index.php?user-master-user-systemmessage"><i class="layui-icon layui-icon-dialogue"></i>系统消息</a></li>
        ...
        <li>
            ...
            <ul class="ul2">
                ...
                <li><a href="index.php?agreement-master-agreement-offer" ><i class="layui-icon layui-icon-engine"></i>报价管理</a></li>
            </ul>
        </li>
