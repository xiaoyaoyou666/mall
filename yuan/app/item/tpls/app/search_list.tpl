...
<div class="zmm-zx-centent bg_fff">
    <div class="container t20 typeMore">
        <div class="cpbox">
            <div class="pull-left alltypes text-center" style="text-align:left;padding-left:22px;"><img
                    style="margin-right:15px;width:24px;height:auto;" src="app/core/styles/images/market/menu1.png"
                    alt="">全部商品分类
            </div>

            <span class="corre" style="margin-top:10px;float: right;margin-right: 10px;">相关商品<i
                    style="font-style: normal;color: #ff8700;">{x2;$countgoodsnum}</i>件</span>
            <div class="pull-left" style="padding:10px 20px;">
                <!--筛选条件-->
                {x2;tree:$menu_list,mlist,menu_listid}
                <a title="{x2;v:mlist['text']}" href="{x2;v:mlist['href']}"
                   class="u-av-label">{x2;v:mlist['text']}<i><img src="app/core/styles/images/close_s.png"
                                                                  style="width: 10px;height:11px;margin-top:-3px"></i></a>
                {x2;endtree}
            </div>
        ...
        <ul class="buycp_list">
            ...
            <li>
                ...
                {x2;endif}
                <a href="index.php?item-app-item&goodsid={x2;v:good['goodsid']}{x2;if:v:good['type']==1}&agreementid={x2;v:good['agreementid']}&p={x2;v:good['goodsminprice']}{x2;endif}">
                ...
                <a href="index.php?item-app-company&companyid={x2;v:good['goodsuserid']}">
                    <div class="gys">
                        ...
                        <div class="pull-left">{x2;$userarr['data'][v:good['goodsuserid']]['company_name']}</div>
                    </div>
                </a>
            </li>
            {x2;endtree}
        </ul>
        <ul style="width: auto;" class="pagination pull-right">{x2;$goods['pages']}</ul>
        {x2;else}
        {x2;include:goodsearch_no}
        {x2;endif}


    </div>
</div>
{x2;include:menu_search}
{x2;include:footer2}
