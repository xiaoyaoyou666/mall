    	<header class="container-fluid" style="background-color:#FFFFFF;border-bottom:1px solid #cccccc;">
			<h5 class="text-center">
				...
				<span class="ttlo" style="color:#000000;">{x2;$pos['posname']}</span>
    	...
    	<div class="container-fluid">
			...
			<h4 class="text-center" style="background:#FFFFFF;margin-top:0.5rem">
				<a href="index.php?item-app-category-pos&catid={x2;$pos['posid']}&page=2" class="ajax" data-page="list" data-target="list" style="line-height:4rem;">查看更多</a>
			</h4>
			{x2;endif}
			{x2;else}
			<h4 class="text-center" style="background:#FFFFFF;margin-top:0.5rem">
