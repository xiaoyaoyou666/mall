        ...
        <div class="col-xs-12 header_top">
            ...
            <ul class="full_right">
                ...
                <li class="phone" style="min-width: 109px;">
                    <a href="{x2;if:$role==0}index.php?user-company{x2;elseif:$role==3}index.php?user-company-index-evaluate_list{x2;elseif:$role==4}index.php?user-company-purchases-inquiry{x2;else}index.php?user-company-index-suplier_list{x2;endif}">{x2;$_user['username']}</a>
                    <ul class="sel_nav" style="height:30px;text-align: center;">
                        <li><a style="margin-right: 0;" class="ajax" href="index.php?user-app-logout">退出登录</a></li>
                    </ul>
