				...
				<div class="foots clearfix">
					...
					<ul style="">
						...
						<li class="fried">
							...
							<a target="_blank" title="" href="{x2;v:link['url']}">{x2;v:link['name']}</a>
							 {x2;endtree}
...
<script>
    $(document).ready(function () {
    	if(document.body.offsetHeight<window.screen.availHeight){
    		var margin_t=window.screen.availHeight-document.body.offsetHeight;
    		$("#footerab").css("margin-top",margin_t);
    	}else{
    		$("#footerab").css("margin-top","20px");
    	}
