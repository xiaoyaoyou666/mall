	...
	<div class="container why-cartbg">
		<form class="wrap" action="index.php?item-app-order" method="post" id="form1">
			...
			<table style="height:86px;">
				...
				<tr style="background: rgba(0,153,68,0.03);border:1px solid rgba(0,153,68,0.10);border-top: 0px;">
					...
					<!--<td>
						<span>公司</span>
						<div class="ul_select">
							<input type="hidden" value="" name="comp_code">
							<input type="text" value="" placeholder="请输入公司" autocomplete="off" class="selects" id="company_name">
							<div class="comp_sel">
							</div>
						</div>
					</td>-->
					...
					<td>
						<span>采购组</span>
						<div class="ul_select">
							<input type="hidden" value="" name="caigou_code">
							<input type="text" value="" placeholder="请输入采购组" autocomplete="off" class="selects">
					...
					<!--<td colspan="3">
						<span>付款条款</span>
						<div class="ul_select">
							<input type="hidden" value="" name="fukuan_code">
							<input type="text" value="" placeholder="请输入付款条款" autocomplete="off" class="selects">
					...
					<!--
					<td colspan="2">
						<span>预付款百分比</span><input name="dppct" type="text" placeholder="0" autocomplete="off" style="width: 100px;">%</td>
						-->
			...
			<table class="cart-list" style="border:1px solid #ededed;margin-top:30px;">
				...
				{x2;eval: v:number = 0} {x2;eval: v:price = 0} {x2;eval: v:allprice = 0}
...
">
	...
	{x2;include:menu} {x2;include:footer2}
	<script>
		...
		$(function() {
			...
			$('#btn').on('click', function() {
				...
				$.ajax({
					...
					url: "index.php?item-app-order-index",
					dataType: 'json',
					success: function(res) {
						if (res.statusCode == 200) {
							var data = {
