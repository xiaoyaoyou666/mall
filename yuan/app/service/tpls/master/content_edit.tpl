				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;overflow:visible">
					...
					<form action="index.php?purchase-master-purchases-edit" method="post" class="form-horizontal">
				        ...
				        <div class="col-sm-9">
				            ...
				            <input type="text" name="args[purchasetitle]" needle="needle" msg="您必须输入标题">
				        </div>
				        <div class="col-sm-9">
				        ...
				        <div class="form-group">
				            <label for="purchasemoduleid" class="control-label col-sm-2">模型：</label>
				            <div class="col-sm-9">
							    <select id="purchasemoduleid" msg="您必须选择信息模型" refreshjs="on" needle="needle" class="combox" name="args[purchasemoduleid]" refUrl="index.php?purchase-master-module-moduleforms&moduleid={value}" target="purchaseforms">
						                	...
						                	<ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
								                <li class="text-center">
								                    <div class="thumbnail">
														...
														<input type="hidden" class="qq-edit-filename-selector" name="args[purchasethumb]" tabindex="0">
													</div>
								                </li>
								            </ul>
								            <ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
									            <li class="text-center">
									                <div class="thumbnail">
														<img class="qq-thumbnail-selector" src="{x2;$purchase['purchasethumb']}" alt="点击上传新图片">
														<input type="hidden" class="qq-edit-filename-selector" name="args[purchasethumb]" tabindex="0" value="{x2;$purchase['purchasethumb']}">
						                			</div>
									            </li>
									        </ul>
						                </div>
