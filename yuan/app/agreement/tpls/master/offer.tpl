...
<div class="goods" class="layui-col-sm12" id="content">
     <div class="head">当前位置：<a href="index.php?item-master-items">采购寻源</a>&nbsp;>&nbsp;报价管理</div>
    <div class="g-content">
        <form action="index.php?agreement-master-agreement-offer" method="post" class="form-inline" id="myForm">
                ...
                <div class="col-xs-9" style="width: 100%;">
                    <div class="row" style="width: 100%;padding-left: 15px;margin-right: -30px;">
                        <div class="col-xs-3" style="float: right;width:12.5%;margin-right: -16px;">
                            <button style="padding:0 18px" class="btn  layui-btn  layui-btn-sm" onclick="doSearch()">查询</button>
    ...
    <form action="index.php?item-master-items-lite" method="post">
        <fieldset class="table-responsive table2excel">
            <table class="layui-table protable"  id="table_a">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        {x2;if:v:content['baojia_status']==1}
                        <td>是</td>
                        {x2;else}
                        <td>否</td>
                        {x2;endif}
                        ...
                        <td class="actions">
                            <div class="btn-group">
                                <a class="layui-btn layui-btn-xs layui-btn-radius layui-btn-normal" href="index.php?user-company-clarify&id={x2;v:content['purchase_new_id']}"><i class="layui-icon">&#xe62d;</i> 详情</a>
                            </div>
                        </td>
                    </tr>
                    {x2;endtree}
            ...
            <ul class="pagination pull-right">{x2;$offerarr['pages']}</ul>
        </fieldset>
    </form>
</div>
</div>
...
<script>
    ...
    function doSearch() {
        ...
        var url = 'index.php?agreement-master-agreement-offer';
        if (keyword != '') {
            url += '&keyword=' + keyword;
        }
        if (purchasetype != '') {
